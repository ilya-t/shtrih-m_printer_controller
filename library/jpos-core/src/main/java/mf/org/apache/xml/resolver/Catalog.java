 ...
 * </dl>
 *
 * @see mf.org.apache.xml.resolver.readers.CatalogReader
 * @see CatalogEntry
 *
 * @author Norman Walsh
...
public class Catalog {
   ...
   *
   * @throws java.net.MalformedURLException  One of the system catalogs is
   * identified with a filename that is not a valid URL.
   * @throws java.io.IOException One of the system catalogs cannot be read.
   */
   ...
   *
   * @throws java.net.MalformedURLException The fileName cannot be turned into
   * a valid URL.
   * @throws java.io.IOException Error reading catalog file.
   */
   ...
   * catalogs.</p>
   *
   * @throws java.net.MalformedURLException The filename (URL) for a
   * subordinate or delegated catalog is not a valid URL.
   * @throws java.io.IOException Error reading some subordinate or delegated
   * catalog file.
   */
   ...
   *
   * @throws java.net.MalformedURLException The formal system identifier of a
   * subordinate catalog cannot be turned into a valid URL.
   * @throws java.io.IOException Error reading subordinate catalog file.
   */
   ...
   * @throws java.io.IOException Error reading delegated catalog file.
   *
   * @return The system identifier to use.
   * Note that the nominal system identifier is not returned if a
   * match is not found in the catalog, instead null is returned
   ...
   *
   * @throws java.net.MalformedURLException The system identifier of a
   * subordinate catalog cannot be turned into a valid URL.
   * @throws java.io.IOException Error reading subordinate catalog file.
   */
