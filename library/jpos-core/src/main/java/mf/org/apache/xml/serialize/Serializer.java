 ...
 * be thrown by {@link org.xml.sax.DocumentHandler#endDocument}. The SAX serializer
 ...
 * DOMSerializer#serialize(mf.org.w3c.dom.Document)} or {@link DOMSerializer#serialize(mf.org.w3c.dom.Element)} methods.
...
public interface Serializer
{
    ...
    /**
     * Return a {@link org.xml.sax.DocumentHandler} interface into this serializer.
     * If the serializer does not support the {@link org.xml.sax.DocumentHandler}
    ...
    /**
     * Return a {@link org.xml.sax.ContentHandler} interface into this serializer.
     * If the serializer does not support the {@link org.xml.sax.ContentHandler}
     * interface, it should return null.
     */
