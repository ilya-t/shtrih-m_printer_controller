...
final class JAXPValidatorComponent 
    ...
    /**
     * Used to store the {@link mf.org.apache.xerces.xni.Augmentations} associated with the
    ...
    /**
     * {@link mf.org.apache.xerces.xni.XMLAttributes} version of {@link #fCurrentAug}.
     */
    ...
    /**
     * 
     * Uses {@link org.xml.sax.helpers.DefaultHandler} as a default implementation of
    ...
    private final class SAX2XNI extends DefaultHandler {
        ...
        /**
         * {@link mf.org.apache.xerces.xni.Augmentations} to send along with events.
         * We reuse one object for efficiency.
         */
        private final Augmentations fAugmentations = new AugmentationsImpl();
        
        /**
         * {@link mf.org.apache.xerces.xni.QName} to send along events.
        ...
        /**
         * Gets the {@link mf.org.apache.xerces.xni.Augmentations} that should be associated with
         * the current event.
         */
        ...
        /**
         * Converts the {@link mf.org.apache.xerces.xni.XNIException} received from a downstream
        ...
        /**
         * Creates a proper {@link mf.org.apache.xerces.xni.QName} object from 3 parts.
         * <p>
     ...
     * 
     * <p>
     * Deriving from {@link mf.org.apache.xerces.impl.xs.opti.DefaultXMLDocumentHandler}
    ...
    /**
     * Compares the given {@link org.xml.sax.Attributes} with {@link #fCurrentAttributes}
