...
public abstract class CharacterDataImpl
   ...
   /** Convenience wrapper for calling setNodeValueInternal when 
     ...
     * 
     * @throws mf.org.w3c.dom.DOMException(NO_MODIFICATION_ALLOWED_ERR) if node is readonly.
     */
     ...
     * 
     * @throws mf.org.w3c.dom.DOMException(INDEX_SIZE_ERR) if offset is negative or
     * greater than length, or if count is negative.
     * 
     * @throws mf.org.w3c.dom.DOMException(NO_MODIFICATION_ALLOWED_ERR) if node is
     * readonly.  
     */
     ...
     * greater than length, or if count is negative.
     *
     * @throws mf.org.w3c.dom.DOMException(WSTRING_SIZE_ERR) In some implementations,
