...
class XMLGregorianCalendarImpl
     ...
     * converting to a {@link java.util.GregorianCalendar}, set to a leap
	 ...
	 *     </tr>
	 *     <tr>
	 *       <th>{@link #setTime(int,int,int, java.math.BigDecimal)}</th>
   ...
   public void clear() {
     ...
     * value==0.
     * @return non-null {@link java.math.BigInteger}.
     */
