 ...
 * @xerces.internal
 *
 * @see RegularExpression#matches(char[], int, int, mf.org.apache.xerces.impl.xpath.regex.Match)
 * @see RegularExpression#matches(char[], mf.org.apache.xerces.impl.xpath.regex.Match)
 * @see RegularExpression#matches(java.text.CharacterIterator, mf.org.apache.xerces.impl.xpath.regex.Match)
 * @see RegularExpression#matches(String, int, int, mf.org.apache.xerces.impl.xpath.regex.Match)
 * @see RegularExpression#matches(String, mf.org.apache.xerces.impl.xpath.regex.Match)
