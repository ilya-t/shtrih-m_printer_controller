 ...
 *
 * <p>The {@link mf.javax.xml.xpath.XPathFactory} class is not thread-safe. In other words,
 * it is the application's responsibility to ensure that at most
 * one thread is using a {@link mf.javax.xml.xpath.XPathFactory} object at any
 * given moment. Implementations are encouraged to mark methods
 * as <code>synchronized</code> to protect themselves from broken clients.
 *
 * <p>{@link mf.javax.xml.xpath.XPathFactory} is not re-entrant. While one of the
