...
/**
 * <p>A processor that checks an XML document against {@link mf.javax.xml.validation.Schema}.</p>
 *
 * <p>
 * A validator object is not thread-safe and not reentrant.
 * In other words, it is the application's responsibility to make
 * sure that one {@link mf.javax.xml.validation.Validator} object is not used from
...
public abstract class Validator {
     ...
     *
     * <p>Derived classes must create {@link mf.javax.xml.validation.Validator} objects that have
     * <code>null</code> {@link org.xml.sax.ErrorHandler} and
     * <code>null</code> {@link mf.org.w3c.dom.ls.LSResourceResolver}.
     * </p>
     */
    protected Validator() {
    }
         ...
         * {@link mf.javax.xml.validation.Schema#newValidator()}.
         ...
         *
         * <p>The reset <code>Validator</code> is not guaranteed to have the same {@link mf.org.w3c.dom.ls.LSResourceResolver} or {@link org.xml.sax.ErrorHandler}
     ...
     * {@link #validate(mf.javax.xml.transform.Source source, mf.javax.xml.transform.Result result)}
     ...
     *      If the {@link org.xml.sax.ErrorHandler} throws a {@link org.xml.sax.SAXException} or
     ...
     *   <code>null</code>.
     *
     * @see #validate(mf.javax.xml.transform.Source source, mf.javax.xml.transform.Result result)
     */
     ...
     * the {@link mf.javax.xml.transform.Source}/{@link mf.javax.xml.transform.Result} accepted.</p>
     *
     * <table border=1>
     * <thead>
     *  <tr>
     ...
     * {@link org.xml.sax.ErrorHandler}.</p>
     *
     ...
     *
     * @see #validate(mf.javax.xml.transform.Source source)
     */
     ...
     *
     * <p>
     * {@link mf.javax.xml.validation.Validator} is not allowed to
     ...
     *
     * <p>
     * When a new {@link mf.javax.xml.validation.Validator} object is created, initially
    ...
    /**
     * Gets the current {@link org.xml.sax.ErrorHandler} set to this {@link mf.javax.xml.validation.Validator}.
     *
     * @return
     *      This method returns the object that was last set through
     *      the {@link #setErrorHandler(org.xml.sax.ErrorHandler)} method, or null
     *      if that method has never been called since this {@link mf.javax.xml.validation.Validator}
     *      has created.
     *
     ...
     *
     * <p>
     * {@link mf.javax.xml.validation.Validator} uses a {@link mf.org.w3c.dom.ls.LSResourceResolver}
     ...
     * then the {@link mf.javax.xml.validation.Validator} will abort the parsing and
    ...
    /**
     * Gets the current {@link mf.org.w3c.dom.ls.LSResourceResolver} set to this {@link mf.javax.xml.validation.Validator}.
     *
     * @return
     *      This method returns the object that was last set through
     ...
     * possible for a {@link mf.javax.xml.validation.Validator} to recognize a feature name but
     ...
     *   {@link mf.javax.xml.validation.Validator} recognizes the feature name but
     ...
     *
     * <p>
     * Feature can be used to control the way a {@link mf.javax.xml.validation.Validator}
     * parses schemas, although {@link mf.javax.xml.validation.Validator}s are not required
     * to recognize any specific feature names.</p>
     *
     * <p>The feature name is any fully-qualified URI.  It is
     * possible for a {@link mf.javax.xml.validation.Validator} to expose a feature value but
     ...
     * possible for a {@link mf.javax.xml.validation.Validator} to recognize a property name but
     * to be unable to change the current value.
     * Some property values may be immutable or mutable only
     * in specific contexts, such as before, during, or after
     * a validation.</p>
     *
     * <p>{@link mf.javax.xml.validation.Validator}s are not required to recognize setting
     ...
     *   value can't be assigned or retrieved.
     * @throws org.xml.sax.SAXNotSupportedException When the
     *   {@link mf.javax.xml.validation.Validator} recognizes the property name but
     *   cannot set the requested value.
     * @throws NullPointerException
     *   When the name parameter is null.
     */
     ...
     *
     * <p>{@link mf.javax.xml.validation.Validator}s are not required to recognize any specific
     * property names.</p>
     *
