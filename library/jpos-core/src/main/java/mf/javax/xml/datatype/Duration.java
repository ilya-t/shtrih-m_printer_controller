 ...
 * The {@link #compare(mf.javax.xml.datatype.Duration duration)} method implements this
 * relationship.</p>
 *
 * <p>See the {@link #isLongerThan(mf.javax.xml.datatype.Duration)} method for details about
 ...
 * <p>
 * Because some operations of <code>Duration</code> rely on {@link java.util.Calendar}
 * even though {@link mf.javax.xml.datatype.Duration} can hold very large or very small values,
 ...
 * @see XMLGregorianCalendar#add(mf.javax.xml.datatype.Duration)
 * @since 1.5
 */
public abstract class Duration {
     ...
     *
     *
     * @see #subtract(mf.javax.xml.datatype.Duration)
     */
     ...
     * {@link XMLGregorianCalendar#add(mf.javax.xml.datatype.Duration)} provides the same
     ...
     *      If the rhs parameter is null.
     *
     * @see #add(mf.javax.xml.datatype.Duration)
     */
     ...
     * of {@link java.math.BigDecimal}. Since all the fields except seconds are
     ...
     *  <li>the years, months and days fields will be added to the {@link java.util.Calendar} object
     *      by using the {@link java.util.Calendar#add(int,int)} method</li>
     ...
     *
     * @see #isShorterThan(mf.javax.xml.datatype.Duration)
     * @see #isLongerThan(mf.javax.xml.datatype.Duration)
     */
     ...
     *
     * @see #isShorterThan(mf.javax.xml.datatype.Duration)
     * @see #compare(mf.javax.xml.datatype.Duration duration)
     */
     ...
     * @throws NullPointerException if <code>duration</code> is null.
     *
     * @see #isLongerThan(mf.javax.xml.datatype.Duration duration)
     * @see #compare(mf.javax.xml.datatype.Duration duration)
     */
    ...
    /**
     * <p>Calls the {@link java.util.Calendar#getTimeInMillis} method.
