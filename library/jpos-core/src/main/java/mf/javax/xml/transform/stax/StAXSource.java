 ...
 * {@link mf.javax.xml.stream.XMLStreamReader} or {@link mf.javax.xml.stream.XMLEventReader}.
 ...
 * @see mf.javax.xml.stream.XMLStreamReader
...
public class StAXSource implements Source {
     ...
     * by supplying an {@link mf.javax.xml.stream.XMLEventReader}.</p>
     *
     * <p><code>XMLEventReader</code> must be a
     * non-<code>null</code> reference.</p>
     *
     * <p><code>XMLEventReader</code> must be in
     * {@link mf.javax.xml.stream.XMLStreamConstants#START_DOCUMENT} or
     * {@link mf.javax.xml.stream.XMLStreamConstants#START_ELEMENT} state.</p>
     *
     * @param xmlEventReader <code>XMLEventReader</code> used to create
     *   this <code>StAXSource</code>.
     *
     * @throws mf.javax.xml.stream.XMLStreamException If <code>xmlEventReader</code> access
    ...
    /**
     * <p>Creates a new instance of a <code>StAXSource</code>
     * by supplying an {@link mf.javax.xml.stream.XMLStreamReader}.</p>
     *
