...
/**
 * Factory that creates {@link mf.javax.xml.validation.Schema} objects&#x2E; Entry-point to
 * the validation API.
 *
 * <p>
 * {@link mf.javax.xml.validation.SchemaFactory} is a schema compiler. It reads external
 * representations of schemas and prepares them for validation.
 *
 * <p>
 * The {@link mf.javax.xml.validation.SchemaFactory} class is not thread-safe. In other words,
 * it is the application's responsibility to ensure that at most
 * one thread is using a {@link mf.javax.xml.validation.SchemaFactory} object at any
 * given moment. Implementations are encouraged to mark methods
 * as <code>synchronized</code> to protect themselves from broken clients.
 *
 * <p>
 * {@link mf.javax.xml.validation.SchemaFactory} is not re-entrant. While one of the
 ...
 * The {@link mf.javax.xml.validation.SchemaFactory} class is capable of locating other
...
public abstract class SchemaFactory {
     ...
     *
     * <p>Derived classes must create {@link mf.javax.xml.validation.SchemaFactory} objects that have
     ...
     * possible for a {@link mf.javax.xml.validation.SchemaFactory} to recognize a feature name but
     ...
     *   {@link mf.javax.xml.validation.SchemaFactory} recognizes the feature name but
     ...
     * {@link mf.javax.xml.validation.Schema}s created by this factory, and by extension,
     * {@link mf.javax.xml.validation.Validator}s and {@link ValidatorHandler}s created by
     * those {@link mf.javax.xml.validation.Schema}s.
     * </p>
     *
     * <p>Implementors and developers should pay particular attention
     * to how the special {@link mf.javax.xml.validation.Schema} object returned by {@link
     ...
     *
     * <p>The feature name is any fully-qualified URI. It is
     * possible for a {@link mf.javax.xml.validation.SchemaFactory} to expose a feature value but
     ...
     * possible for a {@link mf.javax.xml.validation.SchemaFactory} to recognize a property name but
     * to be unable to change the current value.</p>
     *
     * <p>{@link mf.javax.xml.validation.SchemaFactory}s are not required to recognize setting
     ...
     *   value can't be assigned or retrieved.
     * @throws org.xml.sax.SAXNotSupportedException When the
     *   {@link mf.javax.xml.validation.SchemaFactory} recognizes the property name but
     *   cannot set the requested value.
     * @throws NullPointerException If <code>name</code> is <code>null</code>.
     */
     ...
     *
     * <p>{@link mf.javax.xml.validation.SchemaFactory}s are not required to recognize any specific
     * property names.</p>
     *
     ...
     * during schema parsing. When an {@link org.xml.sax.ErrorHandler} is set,
     ...
     * processing by returning normally from the {@link org.xml.sax.ErrorHandler}
     *
     * <p>
     * If any {@link Throwable} (or instances of its derived classes)
     * is thrown from an {@link org.xml.sax.ErrorHandler},
     * the caller of the <code>newSchema</code> method will be thrown
     * the same {@link Throwable} object.
     *
     * <p>
     * {@link mf.javax.xml.validation.SchemaFactory} is not allowed to
     * throw {@link org.xml.sax.SAXException} without first reporting it to
     * {@link org.xml.sax.ErrorHandler}.
     *
     * <p>
     * Applications can call this method even during a {@link mf.javax.xml.validation.Schema}
     * is being parsed.
     *
     * <p>
     ...
     *
     * <p>
     * When a new {@link mf.javax.xml.validation.SchemaFactory} object is created, initially
     * this field is set to null. This field will <em>NOT</em> be
     * inherited to {@link mf.javax.xml.validation.Schema}s, {@link mf.javax.xml.validation.Validator}s, or
     * {@link ValidatorHandler}s that are created from this {@link mf.javax.xml.validation.SchemaFactory}.
     *
    ...
    /**
     * Gets the current {@link org.xml.sax.ErrorHandler} set to this {@link mf.javax.xml.validation.SchemaFactory}.
     *
     * @return
     *      This method returns the object that was last set through
     *      the {@link #setErrorHandler(org.xml.sax.ErrorHandler)} method, or null
     *      if that method has never been called since this {@link mf.javax.xml.validation.SchemaFactory}
     *      has created.
     *
     ...
     *
     * <p>
     * {@link mf.javax.xml.validation.SchemaFactory} uses a {@link mf.org.w3c.dom.ls.LSResourceResolver}
     ...
     * <pre>
     * class DumbDOMResourceResolver implements {@link mf.org.w3c.dom.ls.LSResourceResolver} {
     ...
     * then the {@link mf.javax.xml.validation.SchemaFactory} will abort the parsing and
    ...
    /**
     * Gets the current {@link mf.org.w3c.dom.ls.LSResourceResolver} set to this {@link mf.javax.xml.validation.SchemaFactory}.
     *
     * @return
     *      This method returns the object that was last set through
     ...
     *
     * <p>This is a convenience method for {@link #newSchema(mf.javax.xml.transform.Source[] schemas)}.</p>
     *
     ...
     *
     * <p>This is a convenience method for {@link #newSchema(mf.javax.xml.transform.Source schema)}.</p>
     *
     ...
     *
     * <p>
     * The callee will read all the {@link mf.javax.xml.transform.Source}s and combine them into a
     * single schema. The exact semantics of the combination depends on the schema
     * language that this {@link mf.javax.xml.validation.SchemaFactory} object is created for.
     *
     * <p>
     * When an {@link org.xml.sax.ErrorHandler} is set, the callee will report all the errors
     ...
     * the error must be reported to the {@link org.xml.sax.ErrorHandler}.
     *
     * <h2>RELAX NG</h2>
     *
     ...
     *
     * @param schemas
     *      inputs to be parsed. {@link mf.javax.xml.validation.SchemaFactory} is required
     *      to recognize {@link javax.xml.transform.sax.SAXSource},
     *      {@link mf.javax.xml.transform.stream.StreamSource},
     ...
     *
     * @return
     *      Always return a non-null valid {@link mf.javax.xml.validation.Schema} object.
     *      Note that when an error has been reported, there is no
     *      guarantee that the returned {@link mf.javax.xml.validation.Schema} object is
     *      meaningful.
     *
     * @throws org.xml.sax.SAXException
     *      If an error is found during processing the specified inputs.
     *      When an {@link org.xml.sax.ErrorHandler} is set, errors are reported to
    ...
    /**
     * Creates a special {@link mf.javax.xml.validation.Schema} object.
     *
     * <p>The exact semantics of the returned {@link mf.javax.xml.validation.Schema} object
     * depend on the schema language for which this {@link mf.javax.xml.validation.SchemaFactory}
     * is created.
     *
     ...
     *
     * <p>Implementors and developers should pay particular attention
     * to how the features set on this {@link mf.javax.xml.validation.SchemaFactory} are
     * processed by this special {@link mf.javax.xml.validation.Schema}.
     * In some cases, for example, when the
     * {@link mf.javax.xml.validation.SchemaFactory} and the class actually loading the
     * schema come from different implementations, it may not be possible
     * for {@link mf.javax.xml.validation.SchemaFactory} features to be inherited automatically.
     * Developers should
     * make sure that features, such as secure processing, are explicitly
     * set in both places.</p>
     *
     * <h2>W3C XML Schema 1.0</h2>
     * <p>
     * For XML Schema, this method creates a {@link mf.javax.xml.validation.Schema} object that
     * performs validation by using location hints specified in documents.
     *
     * <p>
     * The returned {@link mf.javax.xml.validation.Schema} object assumes that if documents
     ...
     *
     * @return
     *      Always return non-null valid {@link mf.javax.xml.validation.Schema} object.
     *
     * @throws UnsupportedOperationException
