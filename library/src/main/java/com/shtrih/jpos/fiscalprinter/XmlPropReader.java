...
public class XmlPropReader {
    ...
    private Node root;
    private Node node;
    private static Logger logger = Logger.getLogger(XmlPropReader.class);
    ...
    public PrinterImage readPrinterImage(Node imageNode) throws Exception {
        ...
        image.setFirstLine(readParameterInt(imageNode, "FirstLine"));
    ...
    public void read(Node node, PrinterHeader trailer)
        ...
        boolean doubleWidth = readParameterBool(node, "DoubleWidth");
        trailer.addLine(text, doubleWidth);
    }
