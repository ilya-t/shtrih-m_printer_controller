...
public abstract class SAXParserFactory {
     ...
     *
     * <p> If you have problems loading {@link mf.javax.xml.parsers.DocumentBuilder}s, try:</p>
     * <pre>
     ...
     * @throws org.xml.sax.SAXException for SAX errors.
     */
     ...
     *
         ...
         *     See {@link mf.javax.xml.parsers.SAXParser} <code>parse</code> methods for handler specification.
         *   </li>
         *   <li>
     ...
     * @throws org.xml.sax.SAXNotSupportedException When the underlying XMLReader recognizes the property name but doesn't support the property.
     *
    ...
    */
     ...
     *      if the method was not invoked since a {@link mf.javax.xml.parsers.SAXParserFactory}
     *      is created.
     *
     * @since 1.5
     */
    ...
    */
     ...
     * exception when those properties are set on a {@link mf.javax.xml.parsers.SAXParser}.</p>
     *
