...
public abstract class DatatypeFactory {
    ...
    public static DatatypeFactory newInstance(String factoryClassName, ClassLoader classLoader)
         ...
         * </blockquote>
     * <p>All six values are set and availabe from the created {@link mf.javax.xml.datatype.Duration}</p>
     *
     ...
     * and are availabe using the <code>get</code> methods of  the created {@link mf.javax.xml.datatype.Duration}.
     ...
     * </ul>
         ...
         * so the result of {@link mf.javax.xml.datatype.Duration#getMonths()} and {@link mf.javax.xml.datatype.Duration#getDays()} can be influenced.</p>
         *
     ...
     *
         ...
         *
     * <p>All four values are set and availabe from the created {@link mf.javax.xml.datatype.Duration}</p>
         *
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small values.
     * An {@link UnsupportedOperationException} will be thrown with a message indicating implementation limits
     ...
     * </ul>
         ...
         * This is important as there are variations in the Gregorian Calendar,
         * e.g. leap years have different days in the month = {@link java.util.Calendar#FEBRUARY}
         * so the result of {@link mf.javax.xml.datatype.Duration#getDays()} can be influenced.</p>
         *
     ...
     *   of the duration is zero, this parameter will be ignored.
         ...
         *
     * <p>Both values are set and availabe from the created {@link mf.javax.xml.datatype.Duration}</p>
         *
     * <p>The XML Schema specification states that values can be of an arbitrary size.
     * Implementations may chose not to or be incapable of supporting arbitrarily large and/or small values.
     * An {@link UnsupportedOperationException} will be thrown with a message indicating implementation limits
     ...
     *
         ...
         * This is important as there are variations in the Gregorian Calendar,
         * e.g. leap years have different days in the month = {@link java.util.Calendar#FEBRUARY}
         * so the result of {@link mf.javax.xml.datatype.Duration#getMonths()} can be influenced.</p>
         *
     ...
     * XML Schema 1.0 errata, Section 3.2.7.2</a>.</p>
         ...
         *          {@link java.util.GregorianCalendar} to an {@link XMLGregorianCalendar}
         *       </th>
         *     </tr>
         *     <tr>
         ...
         *       <td>{@link XMLGregorianCalendar#setTime(int hour, int minute, int second, java.math.BigDecimal fractional)}</td>
         *     </tr>
         *     <tr>
         *       <td>
