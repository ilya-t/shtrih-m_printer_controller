...
/**
 * Wraps {@link mf.org.apache.xerces.xni.parser.XMLErrorHandler} and make it look like a SAX {@link org.xml.sax.ErrorHandler}.
 * 
 * <p>
 * The derived class should override the {@link #getErrorHandler()} method
 * so that it will return the correct {@link mf.org.apache.xerces.xni.parser.XMLErrorHandler} instance.
 * This method will be called whenever an error/warning is found.
 * 
 * <p>
 * Experience shows that it is better to store the actual
 * {@link mf.org.apache.xerces.xni.parser.XMLErrorHandler} in one place and looks up that variable,
