...
public interface XPointerPart {
     ...
     * @throws mf.org.apache.xerces.xni.XNIException Thrown if the PointerPart string does not conform to
     ...
     * @throws mf.org.apache.xerces.xni.XNIException Thrown to signal an error
     *   
     */
